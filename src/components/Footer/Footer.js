...
const Footer = () => {
    ...
    const footerLink = [
        ...
        { id: 7, text: 'Rich Hospitality' },
        { id: 8, text: 'Licensed Operator' },
                    ...
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <div className="flex items-center flex-grow">
                            <Link to="/" className="flex items-center space-x-2">
                                ...
                                <h1 className={`text-3xl font-semibold text-gray-800 select-none font-logo`}>Travel Solo</h1>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="bg-red-500">
                    <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                        <p className="text-white text-sm text-center sm:text-left">© 2021 Developed by —
                            <a href="https://github.com/19smabtahinoor" rel="noopener noreferrer" className="text-white ml-1" target="_blank">S.M.Abtahi Noor</a>
                        </p>
                    </div>
                </div>
            </footer>
